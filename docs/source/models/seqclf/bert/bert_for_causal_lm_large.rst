...
.. autofunction:: lucid.models.bert_for_causal_lm_large

The `bert_for_causal_lm_large` function creates a decoder-style BERT-Large model
...
.. code-block:: python
    ...
    >>> model = models.bert_for_causal_lm_large()
    >>> print(model)
    BERTForCausalLM(...)
