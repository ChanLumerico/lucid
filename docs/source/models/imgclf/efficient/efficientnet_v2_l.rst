...
.. autofunction:: lucid.models.efficientnet_v2_l

The `efficientnet_v2_l` function instantiates a large variant of the 
...
The `efficientnet_v2_l` function simplifies the creation of an EfficientNet-v2 model for lightweight tasks
