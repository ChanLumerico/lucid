...
.. autofunction:: lucid.models.se_resnext_50_32x4d

The `se_resnext_50_32x4d` function is a model constructor which creates an 
instance of the SE-ResNeXt-50 (32x4d) architecture, which is a variant of ResNeXt 
that incorporates Squeeze-and-Excitation (SE) blocks for improved performance.

**Total Parameters**: 27,559,896
...
-------
- **SENet**:  
  An instance of the SE-ResNeXt-50 (32x4d) model, ready for training or inference.
...
The following example demonstrates how to instantiate the `se_resnext_50_32x4d` 
model for a custom task:

.. code-block:: python

    from lucid.nn.models import se_resnext_50_32x4d

    # Create the model for a custom task with 1000 classes
    model = se_resnext_50_32x4d(num_classes=1000)
