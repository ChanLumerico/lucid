...
resolutions. Model structure is defined through `SwinTransformerV2Config`.

.. mermaid::
    :name: SwinTransformer-v2
...
- **config** (*SwinTransformerV2Config*):
