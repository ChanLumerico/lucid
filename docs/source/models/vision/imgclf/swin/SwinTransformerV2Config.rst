...
.. autoclass:: lucid.models.SwinTransformerV2Config

`SwinTransformerV2Config` stores the hierarchical stage layout and classifier
settings used by :class:`lucid.models.SwinTransformer_V2`. It exposes the same
configuration surface as `SwinTransformerConfig` for the V2 attention and
