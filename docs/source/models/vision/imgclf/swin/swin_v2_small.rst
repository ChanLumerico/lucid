...
The `swin_v2_small` function constructs the Swin V2-Small preset.
This preset uses the default `SwinTransformerV2Config` stage layout for the small variant.
...
- **SwinTransformer_V2**:
  A Swin Transformer V2 model instance constructed from the small preset config.
