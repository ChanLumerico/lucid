...
The `swin_v2_huge` function constructs the Swin V2-Huge preset.
This preset uses the default `SwinTransformerV2Config` stage layout for the huge variant.
...
- **SwinTransformer_V2**:
  A Swin Transformer V2 model instance constructed from the huge preset config.
