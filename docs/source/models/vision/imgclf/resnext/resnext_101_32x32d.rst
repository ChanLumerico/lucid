...
The `resnext_101_32x32d` function constructs a ResNeXt-101 model with 32 groups and
a base width of 32.
...
- **ResNeXt**:
  A ResNeXt-101 model instance with the preset `(layers=[3, 4, 23, 3], cardinality=32, base_width=32)`.
