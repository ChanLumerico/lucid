...
dimensions, attention heads, depth, and other hyperparameters. Model structure is
defined through `PVTConfig`.
...
- **config** (*PVTConfig*):
  Configuration object describing the image size, initial patch embedding,
  four-stage embedding widths, attention heads, depth schedule, and spatial
  reduction ratios.
