...
The `pvt_v2_b1` function constructs the PVT-v2-B1 preset.
This preset uses the default `PVTV2Config` stage layout for the B1 variant.
...
- **PVT_V2**:
  A PVT-v2 model instance constructed from the B1 preset config.
