...
The `pvt_v2_b2` function constructs the PVT-v2-B2 preset.
This preset uses the default `PVTV2Config` stage layout for the B2 variant.
...
- **PVT_V2**:
  A PVT-v2 model instance constructed from the B2 preset config.
