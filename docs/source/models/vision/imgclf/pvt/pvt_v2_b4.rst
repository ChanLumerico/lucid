...
The `pvt_v2_b4` function constructs the PVT-v2-B4 preset.
This preset uses the default `PVTV2Config` stage layout for the B4 variant.
...
- **PVT_V2**:
  A PVT-v2 model instance constructed from the B4 preset config.
