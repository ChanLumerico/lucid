...
- **EfficientNet**:
   An instance of the `EfficientNet` class configured with parameters for EfficientNet-B6.
...
.. code-block:: python
    ...
    from lucid.models import efficientnet_b6

    # Create an EfficientNet-B6 model
    model = efficientnet_b6(num_classes=1000)
