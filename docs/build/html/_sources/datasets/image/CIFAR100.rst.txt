...
.. autoclass:: lucid.datasets.CIFAR100

The `CIFAR100` class provides access to the CIFAR-100 dataset, 
a widely-used benchmark in the field of image classification. 

This dataset contains 60,000 RGB images (32x32 pixels) across 100 classes, 
...
.. code-block:: python
    ...
    from lucid.datasets import CIFAR100
