...
The `efficientnet_v2_xl` function simplifies the creation of an EfficientNet-v2 model for lightweight tasks
...
**Creating a EfficientNet-v2-XL model**:
...
.. code-block:: python
    ...
    # Instantiate the extra-large variant of EfficientNet_V2
    model = models.efficientnet_v2_xl(num_classes=100, dropout=0.2)
