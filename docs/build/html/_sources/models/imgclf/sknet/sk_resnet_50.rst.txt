...
The `sk_resnet_50` function constructs a Selective Kernel (SK) variant of the ResNet-50 architecture. 
...
-------
- **SKNet**:
  A Selective Kernel ResNet-50 model instance.

Description
-----------
The `sk_resnet_50` function initializes a ResNet-50-like architecture that uses SK blocks for 
...
These layers correspond to the stages of the ResNet-50 backbone, 
with the specified number of blocks per stage.
