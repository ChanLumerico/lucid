...
.. autofunction:: lucid.models.se_resnext_101_32x8d

The `se_resnext_101_32x8d` function is a model constructor which creates an 
instance of the SE-ResNeXt-101 (32x8d) architecture, which is a variant of ResNeXt 
that incorporates Squeeze-and-Excitation (SE) blocks for improved performance.

**Total Parameters**: 93,569,048
...
-------
- **SENet**:  
  An instance of the SE-ResNeXt-101 (32x8d) model, ready for training or inference.
...
The following example demonstrates how to instantiate the `se_resnext_101_32x8d` 
model for a custom task:

.. code-block:: python

    from lucid.nn.models import se_resnext_101_32x8d

    # Create the model for a custom task with 1000 classes
    model = se_resnext_101_32x8d(num_classes=1000)
