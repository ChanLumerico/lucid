...
.. autofunction:: lucid.models.se_resnet_34

Overview
--------

The `se_resnet_34` function constructs an SE-ResNet-34 model, 
a residual network with SE blocks for channel-wise feature recalibration, 
designed for moderately complex image classification tasks.
