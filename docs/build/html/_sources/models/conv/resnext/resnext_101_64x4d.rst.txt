...
The `resnext_101_64x4d` function constructs a ResNeXt-101 model with a configuration 
of 64 groups and a base width of 4. 
...
-------
- **ResNeXt**:
  A ResNeXt-101 model instance with 64 groups and a base width of 4.

Description
-----------
The `resnext_101_64x4d` function initializes a ResNeXt-101-like architecture. 
The model configuration includes:

- **Layers**: [3, 4, 23, 3] stages, each containing a specified number of blocks.
- **Cardinality**: 64 groups for grouped convolutions.
...
.. code-block:: python
    ...
    >>> from lucid.models import resnext_101_64x4d
    >>> model = resnext_101_64x4d(num_classes=1000)
...
.. note::
  ...
  - The `resnext_101_64x4d` function is registered under the model registry 
