...
.. autofunction:: lucid.models.mask2former_swin_small

The `mask2former_swin_small` function builds a `Mask2Former` model with a
Swin-Small backbone preset.

**Total Parameters** (`num_labels=150`): 68,757,537
...
- **Mask2Former**:
  Mask2Former model configured with a Swin-Small backbone.
