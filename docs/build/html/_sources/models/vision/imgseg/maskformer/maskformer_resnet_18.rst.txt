...
.. autofunction:: lucid.models.maskformer_resnet_18

The `maskformer_resnet_18` function builds a `MaskFormer` model with a
...
- **pretrained_backbone** (*bool*, optional):
  If `True`, initializes the ResNet-18 backbone with pretrained classification
  weights.
...
- **MaskFormer**:
  MaskFormer model configured with a ResNet-18 backbone.
