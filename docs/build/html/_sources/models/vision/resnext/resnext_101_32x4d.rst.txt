...
The `resnext_101_32x4d` function constructs a ResNeXt-101 model with a configuration 
...
-------
- **ResNeXt**:
  A ResNeXt-101 model instance with 32 groups and a base width of 4.

Description
-----------
The `resnext_101_32x4d` function initializes a ResNeXt-101-like architecture. 
...
.. code-block:: python
    ...
    >>> from lucid.models import resnext_101_32x4d
    >>> model = resnext_101_32x4d(num_classes=1000)
...
.. note::
  ...
  - The `resnext_101_32x4d` function is registered under the model registry 
