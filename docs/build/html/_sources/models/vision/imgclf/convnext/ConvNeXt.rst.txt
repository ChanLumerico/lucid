...
optimized for image classification tasks. Model structure is defined through
`ConvNeXtConfig`.
...
- **config** (*ConvNeXtConfig*):
  Configuration object describing the stage depths, stage widths, classifier
  size, drop-path rate, and layer-scale initialization value.
...
1. **Hierarchical Stages**:
   - 4 stages with varying depths and dimensions, defined by `ConvNeXtConfig`.
