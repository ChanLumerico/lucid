...
its predecessor. Model structure is defined through `ConvNeXtV2Config`.
...
- **config** (*ConvNeXtV2Config*):
  Configuration object describing the V2 stage depths, stage widths, classifier
  size, and drop-path rate.
