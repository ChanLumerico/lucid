...
classification tasks. Model structure is defined through `CoAtNetConfig`.
...
- **config** (*CoAtNetConfig*):
  Configuration object describing the input resolution, stage depths, stage
  widths, classifier size, attention heads, block types, and optional scaled
  tandem stage settings.
