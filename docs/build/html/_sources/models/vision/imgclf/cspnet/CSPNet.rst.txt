...
This implementation allows flexible injection of several backbone styles through
`CSPNetConfig`, making it suitable for building CSPResNet, CSPDarknet, CSPResNeXt,
and more.
...
- **config** (*CSPNetConfig*):
  Configuration object describing the stage layout, stack type, classifier size,
  normalization and activation choices, split ratio, pooling mode, and head settings.
...
2. **Transform (Part 2)**:
   One part passes through multiple residual blocks.
