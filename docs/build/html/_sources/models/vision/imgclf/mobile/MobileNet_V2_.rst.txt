...
on mobile devices. Model structure is defined through `MobileNetV2Config`.
...
- **config** (*MobileNetV2Config*):
  Configuration object describing the MobileNet-v2 stage layout, stem width,
  final projection width, classifier size, and input channel count.
