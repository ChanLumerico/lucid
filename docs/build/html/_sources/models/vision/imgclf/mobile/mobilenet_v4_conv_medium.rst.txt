...
The `mobilenet_v4_conv_medium` function constructs the MobileNet-v4 Conv Medium model.
...
- **MobileNet_V4**:
  A MobileNet-v4 Conv Medium model instance constructed from the preset stage dictionary.
