...
.. autoclass:: lucid.nn.DepthwiseSeparableConv2d

The `DepthwiseSeparableConv2d` module implements a 2D depthwise separable convolution layer, 
...
.. code-block:: python
    ...
    class lucid.nn.DepthwiseSeparableConv2d(
        in_channels: int,
        out_channels: int,
...
Forward Calculation
--------------------
The `DepthwiseSeparableConv2d` performs the following operations:
...
.. code-block:: python
    ...
    >>> depthwise_separable = nn.DepthwiseSeparableConv2d(
    ...     in_channels=1,
    ...     out_channels=2,
    ...     kernel_size=3,
    ...     stride=1,
