...
.. autoclass:: lucid.nn.BatchNorm2d
    
The `BatchNorm2d` module applies Batch Normalization over a two-dimensional input 
...
Forward Calculation
-------------------
The `BatchNorm2d` module normalizes the input tensor and optionally applies 
...
.. math::
    ...
    \frac{\gamma}{\sqrt{\sigma^2 + \epsilon}} \left( \mathbf{1} - \frac{1}{N \cdot H \cdot W} \right) 
...
.. math::
    ...
    \left( \frac{\mathbf{x}_{i,j,k} - \mu}{\sqrt{\sigma^2 + \epsilon}} \right)
...
Examples
--------
**Using `BatchNorm2d` with a simple input tensor:**
...
.. code-block:: python
    ...
    >>> output = batch_norm(input_tensor)  # Shape: (1, 2, 2, 3)
    >>> print(output)
    Tensor([[
        [[-1.2247, 0.0, 1.2247],
         [-1.2247, 0.0, 1.2247]],
...
**Using `BatchNorm2d` within a simple neural network:**
...
.. code-block:: python
    ...
    ...      [4.0, 5.0, 6.0],
    ...      [7.0, 8.0, 9.0]]
    ... ]], requires_grad=True)  # Shape: (1, 3, 3, 3)
