...
.. autofunction:: lucid.nn.functional.instance_norm

The `instance_norm` function performs instance normalization on the input tensor, 
commonly used in style transfer and image processing applications.
...
- **Tensor**:
    The normalized tensor of the same shape as `input_`, with 
    normalized values for each instance.
