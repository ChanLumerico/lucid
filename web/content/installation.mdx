...
On macOS 26.0 and 26.1, MLX 0.32's macOS 26 build is compiled for 26.2 and may not load. Update macOS, or install the previous MLX with `pip install "mlx<0.32"`.
</Callout>
