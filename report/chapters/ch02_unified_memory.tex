...
\begin{tikzpicture}[
  ...
  step/.style={font=\footnotesize\itshape, color=lucid.muted,
  ...
  \draw[arrow] (mlx_array) -- node[step, right] {step 1: ensure contiguous} (mlx_contig);
  \draw[arrow] (mlx_contig) -- node[step, midway, sloped, above]
    {step 2: materialise} (buffer.north -| mlx_contig.south);
  \draw[arrow] (buffer.north -| cpu_ptr.south) -- node[step, midway, sloped, above]
