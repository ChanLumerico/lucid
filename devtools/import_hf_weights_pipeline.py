...
CANDIDATES: tuple[Candidate, ...] = (
    ...
    Candidate(
        name="mask2former_swin_tiny_ade20k_semantic",
    ...
    Candidate(
        name="mask2former_swin_small_ade20k_semantic",
    ...
    Candidate(
        name="mask2former_swin_base_ade20k_semantic",
    ...
    Candidate(
        name="mask2former_swin_large_ade20k_semantic",
    ...
    Candidate(
        name="mask2former_swin_large_ade20k_panoptic",
        model_key="mask2former_swin_large",
        enum_name="Mask2Former_Swin_Large_Weights",
        family="mask2former",
        dataset="ade20k_panoptic",
        tag="ADE20K_PANOPTIC",
        hf_repo="facebook/mask2former-swin-large-ade-panoptic",
        lucid_ctor="mask2former_swin_large",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_tiny_coco_instance",
        model_key="mask2former_swin_tiny",
        enum_name="Mask2Former_Swin_Tiny_Weights",
        family="mask2former",
        dataset="coco_instance",
        tag="COCO_INSTANCE",
        hf_repo="facebook/mask2former-swin-tiny-coco-instance",
        lucid_ctor="mask2former_swin_tiny",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_small_coco_instance",
        model_key="mask2former_swin_small",
        enum_name="Mask2Former_Swin_Small_Weights",
        family="mask2former",
        dataset="coco_instance",
        tag="COCO_INSTANCE",
        hf_repo="facebook/mask2former-swin-small-coco-instance",
        lucid_ctor="mask2former_swin_small",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_base_coco_instance",
        model_key="mask2former_swin_base",
        enum_name="Mask2Former_Swin_Base_Weights",
        family="mask2former",
        dataset="coco_instance",
        tag="COCO_INSTANCE",
        hf_repo="facebook/mask2former-swin-base-coco-instance",
        lucid_ctor="mask2former_swin_base",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_large_coco_instance",
        model_key="mask2former_swin_large",
        enum_name="Mask2Former_Swin_Large_Weights",
        family="mask2former",
        dataset="coco_instance",
        tag="COCO_INSTANCE",
        hf_repo="facebook/mask2former-swin-large-coco-instance",
        lucid_ctor="mask2former_swin_large",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_tiny_coco_panoptic",
        model_key="mask2former_swin_tiny",
        enum_name="Mask2Former_Swin_Tiny_Weights",
        family="mask2former",
        dataset="coco_panoptic",
        tag="COCO_PANOPTIC",
        hf_repo="facebook/mask2former-swin-tiny-coco-panoptic",
        lucid_ctor="mask2former_swin_tiny",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_small_coco_panoptic",
        model_key="mask2former_swin_small",
        enum_name="Mask2Former_Swin_Small_Weights",
        family="mask2former",
        dataset="coco_panoptic",
        tag="COCO_PANOPTIC",
        hf_repo="facebook/mask2former-swin-small-coco-panoptic",
        lucid_ctor="mask2former_swin_small",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_base_coco_panoptic",
        model_key="mask2former_swin_base",
        enum_name="Mask2Former_Swin_Base_Weights",
        family="mask2former",
        dataset="coco_panoptic",
        tag="COCO_PANOPTIC",
        hf_repo="facebook/mask2former-swin-base-coco-panoptic",
        lucid_ctor="mask2former_swin_base",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_large_coco_panoptic",
        model_key="mask2former_swin_large",
        enum_name="Mask2Former_Swin_Large_Weights",
        family="mask2former",
        dataset="coco_panoptic",
        tag="COCO_PANOPTIC",
        hf_repo="facebook/mask2former-swin-large-coco-panoptic",
        lucid_ctor="mask2former_swin_large",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_tiny_cityscapes_semantic",
        model_key="mask2former_swin_tiny",
        enum_name="Mask2Former_Swin_Tiny_Weights",
        family="mask2former",
        dataset="cityscapes_semantic",
        tag="CITYSCAPES_SEMANTIC",
        hf_repo="facebook/mask2former-swin-tiny-cityscapes-semantic",
        lucid_ctor="mask2former_swin_tiny",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_small_cityscapes_semantic",
        model_key="mask2former_swin_small",
        enum_name="Mask2Former_Swin_Small_Weights",
        family="mask2former",
        dataset="cityscapes_semantic",
        tag="CITYSCAPES_SEMANTIC",
        hf_repo="facebook/mask2former-swin-small-cityscapes-semantic",
        lucid_ctor="mask2former_swin_small",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_base_cityscapes_semantic",
        model_key="mask2former_swin_base",
        enum_name="Mask2Former_Swin_Base_Weights",
        family="mask2former",
        dataset="cityscapes_semantic",
        tag="CITYSCAPES_SEMANTIC",
        hf_repo="facebook/mask2former-swin-base-IN21k-cityscapes-semantic",
        lucid_ctor="mask2former_swin_base",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
        ),
        source_files=("pytorch_model.bin", "model.safetensors"),
        min_match_ratio=0.95,
    ),
    Candidate(
        name="mask2former_swin_large_cityscapes_semantic",
        model_key="mask2former_swin_large",
        enum_name="Mask2Former_Swin_Large_Weights",
        family="mask2former",
        dataset="cityscapes_semantic",
        tag="CITYSCAPES_SEMANTIC",
        hf_repo="facebook/mask2former-swin-large-cityscapes-semantic",
        lucid_ctor="mask2former_swin_large",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_tiny_cityscapes_instance",
        model_key="mask2former_swin_tiny",
        enum_name="Mask2Former_Swin_Tiny_Weights",
        family="mask2former",
        dataset="cityscapes_instance",
        tag="CITYSCAPES_INSTANCE",
        hf_repo="facebook/mask2former-swin-tiny-cityscapes-instance",
        lucid_ctor="mask2former_swin_tiny",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_small_cityscapes_instance",
        model_key="mask2former_swin_small",
        enum_name="Mask2Former_Swin_Small_Weights",
        family="mask2former",
        dataset="cityscapes_instance",
        tag="CITYSCAPES_INSTANCE",
        hf_repo="facebook/mask2former-swin-small-cityscapes-instance",
        lucid_ctor="mask2former_swin_small",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_base_cityscapes_instance",
        model_key="mask2former_swin_base",
        enum_name="Mask2Former_Swin_Base_Weights",
        family="mask2former",
        dataset="cityscapes_instance",
        tag="CITYSCAPES_INSTANCE",
        hf_repo="facebook/mask2former-swin-base-IN21k-cityscapes-instance",
        lucid_ctor="mask2former_swin_base",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_large_cityscapes_instance",
        model_key="mask2former_swin_large",
        enum_name="Mask2Former_Swin_Large_Weights",
        family="mask2former",
        dataset="cityscapes_instance",
        tag="CITYSCAPES_INSTANCE",
        hf_repo="facebook/mask2former-swin-large-cityscapes-instance",
        lucid_ctor="mask2former_swin_large",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_tiny_cityscapes_panoptic",
        model_key="mask2former_swin_tiny",
        enum_name="Mask2Former_Swin_Tiny_Weights",
        family="mask2former",
        dataset="cityscapes_panoptic",
        tag="CITYSCAPES_PANOPTIC",
        hf_repo="facebook/mask2former-swin-tiny-cityscapes-panoptic",
        lucid_ctor="mask2former_swin_tiny",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_small_cityscapes_panoptic",
        model_key="mask2former_swin_small",
        enum_name="Mask2Former_Swin_Small_Weights",
        family="mask2former",
        dataset="cityscapes_panoptic",
        tag="CITYSCAPES_PANOPTIC",
        hf_repo="facebook/mask2former-swin-small-cityscapes-panoptic",
        lucid_ctor="mask2former_swin_small",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_base_cityscapes_panoptic",
        model_key="mask2former_swin_base",
        enum_name="Mask2Former_Swin_Base_Weights",
        family="mask2former",
        dataset="cityscapes_panoptic",
        tag="CITYSCAPES_PANOPTIC",
        hf_repo="facebook/mask2former-swin-base-IN21k-cityscapes-panoptic",
        lucid_ctor="mask2former_swin_base",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
    ...
    Candidate(
        name="mask2former_swin_large_cityscapes_panoptic",
        model_key="mask2former_swin_large",
        enum_name="Mask2Former_Swin_Large_Weights",
        family="mask2former",
        dataset="cityscapes_panoptic",
        tag="CITYSCAPES_PANOPTIC",
        hf_repo="facebook/mask2former-swin-large-cityscapes-panoptic",
        lucid_ctor="mask2former_swin_large",
        required_keys=(
            "class_predictor.weight",
            "model.pixel_level_module.encoder.encoder.layers.0.blocks.0.attn.qkv.weight",
