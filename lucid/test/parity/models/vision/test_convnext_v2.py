"""ConvNeXt V2 parity tests (atto/femto/pico/nano — SC; tiny/small/base — timm; large/huge — heavy).

Uses same key_transform as ConvNeXt V1 (identical attribute structure + GRN)."""
