"""CaiT parity tests (xxsmall_24 — default; others — slow/heavy; all self-consistency)."""
...
_FACTORIES = frozenset({
    M.cait_xxsmall_24_cls, M.cait_xxsmall_36_cls, M.cait_xsmall_24_cls,
    M.cait_small_24_cls, M.cait_small_36_cls,
    M.cait_medium_36_cls, M.cait_medium_48_cls,
})
