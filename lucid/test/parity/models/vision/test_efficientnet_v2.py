"""EfficientNet V2 parity tests (small/medium — slow; large/xlarge — heavy)."""
...
_FACTORIES = frozenset({
    M.efficientnet_v2_small_cls, M.efficientnet_v2_medium_cls,
    M.efficientnet_v2_large_cls, M.efficientnet_v2_xlarge_cls,
})
