"""SE-ResNet parity tests (18 / 34 / 50 / 101 / 152 vs timm seresnet*).

Note: Lucid SE uses Linear (reduction 1/16); timm uses Conv2d (reduction 1/8).
Both named and positional transfer fail due to shape mismatch — expected to skip."""
