...
class TestRCNN:
    def test_factory_and_forward(self, device: str) -> None:
        ...
        proposals = [lucid.tensor(
            [[5.0, 5.0, 40.0, 40.0], [10.0, 10.0, 50.0, 50.0]], device=device,
        )]
        x = _img(device)
        out = m(x, proposals)
...
class TestFastRCNN:
    def test_factory_and_forward(self, device: str) -> None:
        from lucid.models.vision.fast_rcnn import (
            fast_rcnn, FastRCNNForObjectDetection,
        )
...
class TestFasterRCNN:
    def test_factory_and_forward(self, device: str) -> None:
        from lucid.models.vision.faster_rcnn import (
            faster_rcnn, FasterRCNNForObjectDetection,
        )
...
class TestMaskRCNN:
    def test_factory_and_forward(self, device: str) -> None:
        from lucid.models.vision.mask_rcnn import (
            mask_rcnn, MaskRCNNForObjectDetection,
        )
...
class TestEfficientDetD0:
    def test_factory_and_forward(self, device: str) -> None:
        from lucid.models.vision.efficientdet import (
            efficientdet_d0, EfficientDetForObjectDetection,
        )
...
class TestDetectionRegistry:
    def test_detection_models_registered(self) -> None:
        ...
        expected = [
            "rcnn", "fast_rcnn", "faster_rcnn", "mask_rcnn",
            "detr_resnet50",
            "efficientdet_d0", "efficientdet_d7",
            "yolo_v1", "yolo_v1_tiny", "yolo_v2", "yolo_v2_tiny",
            "yolo_v3", "yolo_v3_tiny", "yolo_v4",
        ]
