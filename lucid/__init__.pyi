...
def fliplr(x: Tensor) -> Tensor: ...
def flipud(x: Tensor) -> Tensor: ...
...
def absolute(x) -> Any: ...
def acosh(x) -> Any: ...
def addbmm(input, batch1, batch2, *, beta: float = ..., alpha: float = ...) -> Any: ...
def addcdiv(input, t1, t2, *, value: float = ...) -> Any: ...
def addcmul(input, t1, t2, *, value: float = ...) -> Any: ...
def addmm(input, mat1, mat2, *, beta: float = ..., alpha: float = ...) -> Any: ...
def addmv(input, mat, vec, *, beta: float = ..., alpha: float = ...) -> Any: ...
def addr(input, vec1, vec2, *, beta: float = ..., alpha: float = ...) -> Any: ...
def adjoint(x) -> Any: ...
def arccosh(x) -> Any: ...
def arcsinh(x) -> Any: ...
def arctan2(y, x) -> Any: ...
...
def baddbmm(input, batch1, batch2, *, beta: float = ..., alpha: float = ...) -> Any: ...
def bincount(input, weights = ..., minlength: int = ...) -> Any: ...
def block_diag(*tensors) -> Any: ...
def can_cast(from_dtype, to_dtype) -> bool: ...
def cdist(x1, x2, p: float = ...) -> Any: ...
def column_stack(tensors) -> Any: ...
def conj(x) -> Any: ...
def conj_physical(x) -> Any: ...
def copysign(x, y) -> Any: ...
def corrcoef(input) -> Any: ...
def cov(input, correction: int = ...) -> Any: ...
def digamma(x) -> Any: ...
def divide(a, b) -> Any: ...
def dsplit(x, indices_or_sections) -> Any: ...
def dstack(tensors) -> Any: ...
def erfc(x) -> Any: ...
def expm1(x) -> Any: ...
def float_power(x, y) -> Any: ...
def fmax(a, b) -> Any: ...
def fmin(a, b) -> Any: ...
def gcd(x, y) -> Any: ...
def ger(vec1, vec2) -> Any: ...
def heaviside(x, values) -> Any: ...
def histogram(input, bins = ..., range = ..., density: bool = ..., weight = ...) -> Any: ...
def hsplit(x, indices_or_sections) -> Any: ...
def i0(x) -> Any: ...
def index_add(input, dim: int, index, source, alpha: float = ...) -> Any: ...
def index_copy(input, dim: int, index, source) -> Any: ...
def index_fill(input, dim: int, index, value: float) -> Any: ...
def is_conj(x) -> bool: ...
def is_neg(x) -> bool: ...
def is_nonzero(x) -> bool: ...
def is_same_size(a, b) -> bool: ...
def is_storage(x) -> bool: ...
def isin(elements, test_elements, *, invert: bool = ...) -> Any: ...
def isneginf(x) -> Any: ...
def isposinf(x) -> Any: ...
def isreal(x) -> Any: ...
def lcm(x, y) -> Any: ...
def ldexp(input, exponent) -> Any: ...
def lgamma(x) -> Any: ...
def logit(x, eps: float | None = ...) -> Any: ...
def masked_scatter(input, mask, source) -> Any: ...
def moveaxis(x, source, destination) -> Any: ...
def multinomial(input, num_samples: int, replacement: bool = ..., *, generator = ...) -> Any: ...
def multiply(a, b) -> Any: ...
def mv(mat, vec) -> Any: ...
def nanmean(x, dim = ..., keepdim: bool = ...) -> Any: ...
def nanmedian(x, dim = ..., keepdim: bool = ...) -> Any: ...
def nanquantile(input, q, dim = ..., keepdim: bool = ..., interpolation: str = ...) -> Any: ...
def nansum(x, dim = ..., keepdim: bool = ...) -> Any: ...
def negative(x) -> Any: ...
def numel(x) -> int: ...
def positive(x) -> Any: ...
def promote_types(a_dtype, b_dtype) -> Any: ...
def quantile(input, q, dim = ..., keepdim: bool = ..., interpolation: str = ...) -> Any: ...
def resolve_conj(x) -> Any: ...
def resolve_neg(x) -> Any: ...
def result_type(a, b) -> Any: ...
def rot90(x, k: int = ..., dims: Sequence[int] = ...) -> Any: ...
def row_stack(tensors) -> Any: ...
def rsub(a, b, *, alpha: float = ...) -> Any: ...
def scatter_reduce(input, dim: int, index, src, reduce: str = ..., include_self: bool = ...) -> Any: ...
def signbit(x) -> Any: ...
def sinc(x) -> Any: ...
def subtract(a, b, *, alpha: float = ...) -> Any: ...
def swapaxes(x, axis0: int, axis1: int) -> Any: ...
def swapdims(x, dim0: int, dim1: int) -> Any: ...
def t(x) -> Any: ...
def take_along_dim(x, indices, dim: int) -> Any: ...
def tensor_split(x, indices_or_sections, dim: int = ...) -> Any: ...
def true_divide(a, b) -> Any: ...
def vander(x, N: int | None = ..., increasing: bool = ...) -> Any: ...
def vdot(a, b) -> Any: ...
def vsplit(x, indices_or_sections) -> Any: ...
def xlogy(x, y) -> Any: ...

# ── Tensor-method aliases ─────────────────
def diff(input, *args, **kwargs) -> Any: ...
def lerp(input, *args, **kwargs) -> Any: ...
