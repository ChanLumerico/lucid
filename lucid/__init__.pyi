...
def reshape(x: Tensor, *args: Any, **kwargs: Any) -> Tensor: ...
...
def expand(x: Tensor, *args: Any, **kwargs: Any) -> Tensor: ...
...
def masked_fill(x: Tensor, y: Tensor | float, *args: Any, **kwargs: Any) -> Tensor: ...
...
def meshgrid(tensors: list[Tensor], *args: object) -> Tensor: ...
