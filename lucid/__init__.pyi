...
def unsqueeze(input: Tensor, dim: DimLike) -> Tensor:
    ...
    """
    ...
def flatten(input: Tensor, start_axis: _int = ..., end_axis: _int = ...) -> Tensor:
    ...
    """
    ...
def permute(input: Tensor, *dims: _int | Sequence[_int]) -> Tensor:
...
def broadcast_to(input: Tensor, shape: ShapeLike) -> Tensor:
    ...
    """
    ...
def expand(input: Tensor, *sizes: _int | Sequence[_int]) -> Tensor:
...
def tile(input: Tensor, reps: Sequence[_int]) -> Tensor:
    ...
    """
    ...
def flip(input: Tensor, dims: _int | Sequence[_int]) -> Tensor:
...
def flipud(input: Tensor) -> Tensor:
    ...
    """
    ...
def roll(input: Tensor, shifts: _int | Sequence[_int], dims: Sequence[_int]) -> Tensor:
    ...
    """
    ...
def tril(input: Tensor, k: _int = ...) -> Tensor:
    ...
    """
    ...
def triu(input: Tensor, k: _int = ...) -> Tensor:
    ...
    """
    ...
def pad(input: Tensor, padding: Sequence[_int], mode: str = ..., value: _float = ...) -> Tensor:
...
def less_equal(input: Tensor, other: Tensor | Scalar) -> Tensor:
    ...
    """
    ...
def where(cond: Tensor, x: TensorOrScalar, y: TensorOrScalar) -> Tensor:
    ...
    """
    ...
def masked_fill(input: Tensor, mask: Tensor, value: _float) -> Tensor:
...
def isfinite(input: Tensor) -> Tensor:
    ...
    """
    ...
def nan_to_num(input: Tensor, nan: _float | None = ..., posinf: _float | None = ..., neginf: _float | None = ...) -> Tensor:
...
def nextafter(input: Tensor, other: Tensor | Scalar) -> Tensor:
    ...
    """
    ...
def logsumexp(input: Tensor, dim: _int | Sequence[_int] | None = ..., keepdim: _bool = ...) -> Tensor:
...
def take(input: Tensor, indices: Tensor) -> Tensor:
    ...
    """
    ...
def index_select(input: Tensor, dim: _int, index: Tensor) -> Tensor:
...
def narrow(input: Tensor, dim: _int, start: _int, length: _int) -> Tensor:
    ...
    """
    ...
def scatter(base_impl: Tensor, dim: _int, index: Tensor, src: Tensor, reduce: str | None = ...) -> Tensor:
...
def movedim(input: Tensor, source: _int | Sequence[_int], destination: _int | Sequence[_int]) -> Tensor:
    ...
    """
    ...
def unflatten(input: Tensor, dim: _int, sizes: Sequence[_int]) -> Tensor:
    ...
    """
    ...
def histc(input: Tensor, bins: _int = ..., min: _float = ..., max: _float = ...) -> Tensor:
...
def cartesian_prod(*tensors: Tensor) -> Tensor:
    ...
    *tensors : Tensor
    ...
    """
    ...
def searchsorted(sorted_seq: Tensor, values: Tensor, *, right: _bool = ...) -> Tensor:
    ...
    """
    ...
def bucketize(values: Tensor, boundaries: Tensor, *, right: _bool = ...) -> Tensor:
...
def masked_select(input: Tensor, mask: Tensor) -> Tensor:
    ...
    """
    ...
def isclose(input: Tensor | Scalar, other: Tensor | Scalar, rtol: _float = ..., atol: _float = ..., equal_nan: _bool = ...) -> Tensor:
    ...
    """
    ...
def view(input: Tensor, *shape: _int | Sequence[_int]) -> Tensor:
    ...
    """
    ...
def concat(tensors: list[Tensor], dim: _int = ...) -> Tensor:
...
def addbmm(input: Tensor, batch1: Tensor, batch2: Tensor, *, beta: _float = ..., alpha: _float = ...) -> Tensor: ...
def addcdiv(input: Tensor, t1: Tensor, t2: Tensor, *, value: _float = ...) -> Tensor: ...
def addcmul(input: Tensor, t1: Tensor, t2: Tensor, *, value: _float = ...) -> Tensor: ...
def addmm(input: Tensor, mat1: Tensor, mat2: Tensor, *, beta: _float = ..., alpha: _float = ...) -> Tensor: ...
def addmv(input: Tensor, mat: Tensor, vec: Tensor, *, beta: _float = ..., alpha: _float = ...) -> Tensor: ...
def addr(input: Tensor, vec1: Tensor, vec2: Tensor, *, beta: _float = ..., alpha: _float = ...) -> Tensor: ...
def adjoint(x: Tensor) -> Tensor: ...
def allclose(a: Tensor, b: Tensor, rtol: _float = ..., atol: _float = ..., equal_nan: _bool = ...) -> _bool: ...
def amax(x: Tensor, dim: _int | Sequence[_int] | None = ..., keepdim: _bool = ...) -> Tensor: ...
def amin(x: Tensor, dim: _int | Sequence[_int] | None = ..., keepdim: _bool = ...) -> Tensor: ...
...
def baddbmm(input: Tensor, batch1: Tensor, batch2: Tensor, *, beta: _float = ..., alpha: _float = ...) -> Tensor: ...
def bincount(input: Tensor, weights: Tensor | None = ..., minlength: _int = ...) -> Tensor: ...
def block_diag(*tensors: Tensor) -> Tensor: ...
def can_cast(from_dtype: dtype, to_dtype: dtype) -> _bool: ...
def cdist(x1: Tensor, x2: Tensor, p: _float = ...) -> Tensor: ...
...
def count_nonzero(x: Tensor, dim: _int | Sequence[_int] | None = ...) -> Tensor: ...
def cov(input: Tensor, correction: _int = ...) -> Tensor: ...
def diag_embed(x: Tensor, offset: _int = ..., dim1: _int = ..., dim2: _int = ...) -> Tensor: ...
def digamma(x: Tensor) -> Tensor: ...
def divide(a: Tensor, b: Tensor | Scalar) -> Tensor: ...
def dsplit(x: Tensor, indices_or_sections: _int | Sequence[_int]) -> list[Tensor]: ...
...
def histogram(input: Tensor, bins: _int | Sequence[_float] = ..., range: tuple[_float, _float] | None = ..., density: _bool = ..., weight: Tensor | None = ...) -> tuple[Tensor, Tensor]: ...
def histogram2d(x: Tensor, y: Tensor, bins: _int | tuple[_int, _int] = ..., range: tuple[tuple[_float, _float], tuple[_float, _float]] | None = ..., density: _bool = ...) -> tuple[Tensor, Tensor, Tensor]: ...
def histogramdd(input: Tensor, bins: _int | Sequence[_int] = ..., range: Sequence[tuple[_float, _float]] | None = ..., density: _bool = ...) -> tuple[Tensor, list[Tensor]]: ...
def hsplit(x: Tensor, indices_or_sections: _int | Sequence[_int]) -> list[Tensor]: ...
def i0(x: Tensor) -> Tensor: ...
def index_add(input: Tensor, dim: _int, index: Tensor, source: Tensor, alpha: _float = ...) -> Tensor: ...
def index_copy(input: Tensor, dim: _int, index: Tensor, source: Tensor) -> Tensor: ...
def index_fill(input: Tensor, dim: _int, index: Tensor, value: _float) -> Tensor: ...
def index_put(input: Tensor, indices: list[Tensor] | tuple[Tensor, ...], values: Tensor, accumulate: _bool = ...) -> Tensor: ...
def index_put_(input: Tensor, indices: list[Tensor] | tuple[Tensor, ...], values: Tensor, accumulate: _bool = ...) -> Tensor: ...
def is_conj(x: Tensor) -> _bool: ...
def is_neg(x: Tensor) -> _bool: ...
def is_nonzero(x: Tensor) -> _bool: ...
def is_same_size(a: Tensor, b: Tensor) -> _bool: ...
def is_storage(x: Tensor) -> _bool: ...
def isin(elements: Tensor | TensorLike, test_elements: Tensor | TensorLike, *, invert: _bool = ...) -> Tensor: ...
...
def logit(x: Tensor, eps: _float | None = ...) -> Tensor: ...
def masked_scatter(input: Tensor, mask: Tensor, source: Tensor) -> Tensor: ...
def moveaxis(x: Tensor, source: _int | Sequence[_int], destination: _int | Sequence[_int]) -> Tensor: ...
def multinomial(input: Tensor, num_samples: _int, replacement: _bool = ..., *, generator: _C_engine.Generator | None = ...) -> Tensor: ...
def multiply(a: Tensor, b: Tensor | Scalar) -> Tensor: ...
def mv(mat: Tensor, vec: Tensor) -> Tensor: ...
def nanmean(x: Tensor, dim: _int | Sequence[_int] | None = ..., keepdim: _bool = ...) -> Tensor: ...
def nanmedian(x: Tensor, dim: _int | None = ..., keepdim: _bool = ...) -> Tensor: ...
def nanquantile(input: Tensor, q: _float | Sequence[_float] | Tensor, dim: _int | None = ..., keepdim: _bool = ..., interpolation: str = ...) -> Tensor: ...
def nansum(x: Tensor, dim: _int | Sequence[_int] | None = ..., keepdim: _bool = ...) -> Tensor: ...
...
def quantile(input: Tensor, q: _float | Sequence[_float] | Tensor, dim: _int | None = ..., keepdim: _bool = ..., interpolation: str = ...) -> Tensor: ...
def resolve_conj(x: Tensor) -> Tensor: ...
def resolve_neg(x: Tensor) -> Tensor: ...
def result_type(a: Tensor | Scalar, b: Tensor | Scalar) -> dtype: ...
def rot90(x: Tensor, k: _int = ..., dims: Sequence[_int] = ...) -> Tensor: ...
def row_stack(tensors: Sequence[Tensor]) -> Tensor: ...
def rsub(a: Tensor, b: Tensor | Scalar, *, alpha: _float = ...) -> Tensor: ...
def scatter_reduce(input: Tensor, dim: _int, index: Tensor, src: Tensor, reduce: str = ..., include_self: _bool = ...) -> Tensor: ...
def signbit(x: Tensor) -> Tensor: ...
def sinc(x: Tensor) -> Tensor: ...
def std_mean(x: Tensor, dim: _int | Sequence[_int] | None = ..., correction: _int = ..., keepdim: _bool = ...) -> tuple[Tensor, Tensor]: ...
def subtract(a: Tensor, b: Tensor | Scalar, *, alpha: _float = ...) -> Tensor: ...
def swapaxes(x: Tensor, axis0: _int, axis1: _int) -> Tensor: ...
def swapdims(x: Tensor, dim0: _int, dim1: _int) -> Tensor: ...
def t(x: Tensor) -> Tensor: ...
def take_along_dim(x: Tensor, indices: Tensor, dim: _int) -> Tensor: ...
def tensor_split(x: Tensor, indices_or_sections: _int | Sequence[_int], dim: _int = ...) -> list[Tensor]: ...
def tril_indices(row: _int, col: _int | None = ..., offset: _int = ..., *, dtype: DTypeLike = ..., device: DeviceLike = ...) -> Tensor: ...
def triu_indices(row: _int, col: _int | None = ..., offset: _int = ..., *, dtype: DTypeLike = ..., device: DeviceLike = ...) -> Tensor: ...
def true_divide(a: Tensor, b: Tensor | Scalar) -> Tensor: ...
def var_mean(x: Tensor, dim: _int | Sequence[_int] | None = ..., correction: _int = ..., keepdim: _bool = ...) -> tuple[Tensor, Tensor]: ...
def vdot(a: Tensor, b: Tensor) -> Tensor: ...
def view_as_complex(input: Tensor) -> Tensor: ...
def view_as_real(input: Tensor) -> Tensor: ...
def vsplit(x: Tensor, indices_or_sections: _int | Sequence[_int]) -> list[Tensor]: ...
