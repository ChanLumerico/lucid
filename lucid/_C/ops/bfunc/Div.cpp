...
const OpSchema DivBackward::schema_v1{
    "div", /*version=*/1, AmpPolicy::Promote, /*deterministic=*/true};

CpuStorage DivBackward::cpu_kernel(const CpuStorage& a, const CpuStorage& b,
