...
public:
    ...
    std::vector<Storage> apply(Storage grad_out) override {
        if (device_ == Device::GPU) {
            ...
            auto da = ::mlx::core::matmul(*gg.arr,
                          ::mlx::core::reshape(*gb.arr,
                              ::mlx::core::Shape{static_cast<int>(N_), 1}));
            da = ::mlx::core::squeeze(da, 1);
            auto db = ::mlx::core::matmul(
                ::mlx::core::reshape(*ga.arr,
                    ::mlx::core::Shape{1, static_cast<int>(M_)}), *gg.arr);
        ...
        auto run = [&](auto* dap, auto* dbp, const auto* gp,
                       const auto* ap, const auto* bp) {
