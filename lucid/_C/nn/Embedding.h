...
class LUCID_API RotaryPosEmbeddingBackward
    : public FuncOp<RotaryPosEmbeddingBackward, 1> {
public:
    static const OpSchema schema_v1;
...
LUCID_API TensorImplPtr sinusoidal_pos_embedding_op(
    std::int64_t seq_len, std::int64_t embed_dim, Dtype dtype, Device device);

LUCID_API TensorImplPtr rotary_pos_embedding_op(
