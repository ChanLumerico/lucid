...
void register_bfunc(py::module_& m) {
    ...
    m.def("add",     &add_op,     py::arg("a"), py::arg("b"),
          "Element-wise a + b (vDSP_vadd).");
    m.def("sub",     &sub_op,     py::arg("a"), py::arg("b"),
          "Element-wise a - b (vDSP_vsub).");
    m.def("mul",     &mul_op,     py::arg("a"), py::arg("b"),
          "Element-wise a * b (vDSP_vmul).");
    m.def("div",     &div_op,     py::arg("a"), py::arg("b"),
          "Element-wise a / b (vDSP_vdiv).");
    m.def("pow",     &pow_op,     py::arg("a"), py::arg("b"),
          "Element-wise a ** b (vForce vvpowf).");
    ...
    m.def("tensordot", &tensordot_op,
          py::arg("a"), py::arg("b"),
          py::arg("axes_a"), py::arg("axes_b"));
