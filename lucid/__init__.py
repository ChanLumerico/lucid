...
def _register(names: frozenset[str]) -> Callable[
    [Callable[[], dict[str, object]]], Callable[[], dict[str, object]]
]:
...
def _load_predicates() -> dict[str, object]:
    ...
    _SIGNED_DTYPES = frozenset([_ce.F16, _ce.F32, _ce.F64, _ce.C64,
                                 _ce.I8, _ce.I16, _ce.I32, _ce.I64])
...
def _load_type_aliases() -> dict[str, object]:
    ...
    return dict(
        ...
        DeviceLike=DeviceLike, DTypeLike=DTypeLike, ShapeLike=ShapeLike,
        StateDict=StateDict, TensorOrScalar=TensorOrScalar,
