...
from lucid.types import _MLXArray, _NumPyArray, _TensorLike
...
def _coerce_grad_output(
    output: _TensorLike,
    grad_output: _TensorLike | _NumPyArray | _MLXArray | object | None,
...
def grad(
    ...
    grad_outputs: _TensorLike | Iterable[_TensorLike] | Iterable[object] | None = None,
    retain_graph: bool = False,
    allow_unused: bool = False,
) -> tuple[_NumPyArray | _MLXArray | None, ...] | _NumPyArray | _MLXArray | None:
