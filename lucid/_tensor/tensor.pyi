...
class Tensor:
    ...
    def sum(self, dim: DimLike = ..., keepdim: bool = ..., axis: object = ..., axes: object = ..., keepdims: bool = ...) -> Tensor: ...
    def mean(self, dim: DimLike = ..., keepdim: bool = ..., axis: object = ..., axes: object = ..., keepdims: bool = ...) -> Tensor: ...
    def prod(self, dim: DimLike = ..., keepdim: bool = ..., axis: object = ..., axes: object = ..., keepdims: bool = ...) -> Tensor: ...
    def max(self, dim: DimLike = ..., keepdim: bool = ..., axis: object = ..., axes: object = ..., keepdims: bool = ...) -> Tensor: ...
    def min(self, dim: DimLike = ..., keepdim: bool = ..., axis: object = ..., axes: object = ..., keepdims: bool = ...) -> Tensor: ...
    def var(self, dim: DimLike = ..., keepdim: bool = ..., correction: int = ..., unbiased: bool | None = ..., axis: object = ..., axes: object = ..., keepdims: bool = ...) -> Tensor: ...
    def argmax(self, dim: DimLike = ..., keepdim: bool = ..., axis: object = ..., keepdims: bool = ...) -> Tensor: ...
    def argmin(self, dim: DimLike = ..., keepdim: bool = ..., axis: object = ..., keepdims: bool = ...) -> Tensor: ...
    def cumsum(self, axis: object = ...) -> Tensor: ...
    def cumprod(self, axis: object = ...) -> Tensor: ...
    def cummax(self, axis: object = ...) -> Tensor: ...
    def cummin(self, axis: object = ...) -> Tensor: ...
    def erf(self) -> Tensor: ...
    def erfinv(self) -> Tensor: ...
    def trace(self) -> Tensor: ...
    def reshape(self) -> Tensor: ...
    def squeeze(self, dim: DimLike = ...) -> Tensor: ...
    def squeeze_all(self) -> Tensor: ...
    def unsqueeze(self, dim: DimLike = ...) -> Tensor: ...
    def flatten(self, start: float = ..., end: float = ...) -> Tensor: ...
    def permute(self) -> Tensor: ...
    def transpose(self) -> Tensor: ...
    def swapaxes(self, d0: object = ..., d1: object = ...) -> Tensor: ...
    def broadcast_to(self, shape: ShapeLike = ...) -> Tensor: ...
    def expand(self) -> Tensor: ...
    def expand_dims(self, axis: object = ...) -> Tensor: ...
    def repeat(self) -> Tensor: ...
    def tile(self, reps: Sequence[int] = ...) -> Tensor: ...
    def flip(self, dims: Sequence[int] = ...) -> Tensor: ...
    def fliplr(self) -> Tensor: ...
    def flipud(self) -> Tensor: ...
    def roll(self, shifts: int | Sequence[int] = ..., dims: Sequence[int] = ...) -> Tensor: ...
    def tril(self, k: int = ...) -> Tensor: ...
    def triu(self, k: int = ...) -> Tensor: ...
    def pad(self, padding: Sequence[int] | Sequence[tuple[int, int]] = ..., mode: str = ..., value: Scalar = ...) -> Tensor: ...
    def gather(self, other: Tensor | float, dim: DimLike = ...) -> Tensor: ...
    def sort(self, dim: DimLike = ..., descending: object = ...) -> Tensor: ...
    def argsort(self, dim: DimLike = ..., descending: object = ...) -> Tensor: ...
    def nonzero(self) -> Tensor: ...
    def topk(self, k: int = ..., dim: DimLike = ..., largest: bool = ...) -> Tensor: ...
    def diagonal(self, offset: int = ..., dim1: int = ..., dim2: int = ...) -> Tensor: ...
    def masked_fill(self, value: Scalar = ...) -> Tensor: ...
    def split(self, dim: DimLike = ...) -> Tensor: ...
    def chunk(self, n: int = ..., axis: object = ...) -> Tensor: ...
    def unbind(self, axis: object = ...) -> Tensor: ...
    def softmax(self, axis: object = ...) -> Tensor: ...
    def log_softmax(self, axis: object = ...) -> Tensor: ...
    def rsqrt(self) -> Tensor: ...
    def std(self, dim: DimLike = ..., keepdim: bool = ..., correction: int = ..., unbiased: bool | None = ..., axis: object = ..., axes: object = ..., keepdims: bool = ...) -> Tensor: ...
    def any(self) -> Tensor: ...
    def all(self) -> Tensor: ...
    def clip(self, min: Scalar | None = ..., max: Scalar | None = ...) -> Tensor: ...
    def isinf(self) -> Tensor: ...
    def isnan(self) -> Tensor: ...
    def isfinite(self) -> Tensor: ...
    def nan_to_num(self, nan: float | None = ..., posinf: float | None = ..., neginf: float | None = ...) -> Tensor: ...
    def detach(self) -> Tensor: ...
    def clone(self) -> Tensor: ...
    def clamp(self, min: Scalar | None = ..., max: Scalar | None = ...) -> Tensor: ...
    ...
    def scatter(self, reduce: str | None = ...) -> Tensor: ...
    ...
    def bitwise_left_shift(self, other: Tensor | float) -> Tensor: ...
    def bitwise_right_shift(self, other: Tensor | float) -> Tensor: ...
    def masked_select(self, other: Tensor | float) -> Tensor: ...
    def isclose(self, other: Tensor | float, rtol: float = ..., atol: float = ..., equal_nan: object = ...) -> Tensor: ...
